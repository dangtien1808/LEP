...
<html >
    <head>
        ...
        <link href="../public/dist/plugins/css/bootstrap.css" rel="stylesheet" type="text/css" >
        <link href="../public/dist/plugins/css/dropzone.css" rel="stylesheet" type="text/css" >

        <script src='../public/dist/plugins/js/jquery.js'></script>
        <script src='../public/dist/plugins/js/bootstrap.js'></script>
        <script src='../public/dist/plugins/js/dropzone.js'></script>
    </head>
    <body>
